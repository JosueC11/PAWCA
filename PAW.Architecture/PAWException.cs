...
/// </summary>
public class PAWCAException : Exception
{
    ...
    /// </summary>
    public PAWCAException(string message)
    {
    ...
    public PAWCAException(Exception ex)
    {
        exception = ex;
    }
    ...
    public static PAWCAException MustThrow()
    {
        return new PAWCAException();
    }
    ...
    /// </summary>
    /// <returns>This method does not return a value.</returns>
    public static PAWCAException MustThrow(string message)
    {
        return new PAWCAException(message);
    }
    ...
    /// <param name="ex">The inner exception that caused this exception.</param>
    /// <returns>This method does not return a value.</returns>
    public static PAWCAException MustThrow(Exception ex)
    {
        return new PAWCAException(ex);
    }
